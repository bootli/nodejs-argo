...
const UUID = process.env.UUID || 'c416332e-2bde-4806-ac02-8f021c6e8f68'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || 'vps.zjxs.top:443';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '94onnWvXTosYZB1VLP20T6M2SoioTbOf';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
